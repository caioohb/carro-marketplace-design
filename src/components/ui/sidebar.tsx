    ...
    return (
      <div
        ...
        className={cn(
          ...
          "w-[--sidebar-width] bg-sidebar border-r border-sidebar-border",
          className
        )}
        {...props}
      >
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none transition-colors",
        className
      )}
      {...props}
    />
